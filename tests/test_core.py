...
def test_get_total_expenses_com_varias_despesas(mocker):
    ...
    mock_repo.get_all.return_value = [
        Expense(id=1, description="Lanche", amount=10.50, category="c", date=date.today()),
        Expense(id=2, description="Cinema", amount=20.00, category="c", date=date.today()),
        Expense(id=3, description="Cafe", amount=0.50, category="c", date=date.today()),
    ]
